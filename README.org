#+TITLE: Missing in Michigan System (MIMS)
#+STARTUP: indent
...
|------------+-----------+----------------+------------+--------------------+--------------------+-----------------|
| User       | One       | [[mailto:user1@test.com][user1@test.com]] | 1111111111 | =7.m]VQ=           | =7.m]VQ=           | Law Enforcement |
| User       | Two       | [[mailto:user2@test.com][user2@test.com]] | 2222222222 | =_2BueD=           | =_2BueD=           | Law Enforcement |
| User       | Three     | [[mailto:user3@test.com][user3@test.com]] | 3333333333 | =vjGPs8pP/M5e=     | =vjGPs8pP/M5e=     | Law Enforcement |
| User       | Four      | [[mailto:user4@test.com][user4@test.com]] | 4444444444 | =\%T6MypWa'dK=     | =\%T6MypWa'dK=     | Public          |
| User       | Five      | [[mailto:user5@test.com][user5@test.com]] | 5555555555 | =ra7)#7#U8%tA!)Zx= | =ra7)#7#U8%tA!)Zx= | Public          |
| User       | Six       | [[mailto:user6@test.com][user6@test.com]] | 6666666666 | =s$J}Lbys)(t8<yd5= | =s$J}Lbys)(t8<yd5= | Public          |
...
| Username        | Password           |
|-----------------+--------------------|
| [[mailto:user1@test.com][user1@test.com]]  | =7.m]VQ=           |
| [[mailto:user2@test.com][user2@test.com]]  | =_2BueD=           |
| [[mailto:user3@test.com][user3@test.com]]  | =vjGPs8pP/M5e=     |
| [[mailto:user4@test.com][user4@test.com]]  | =\%T6MypWa'dK=     |
| [[mailto:user5@test.com][user5@test.com]]  | =ra7)#7#U8%tA!)Zx= |
| [[mailto:user6@gmail.com][user6@gmail.com]] | =s$J}Lbys)(t8<yd5= |
...
| Email             |      Phone |
|-------------------+------------|
| [[mailto:newuser1@test.com][newuser1@test.com]] | 0000000000 |
| [[mailto:newuser2@test.com][newuser2@test.com]] | 9999999999 |
| [[mailto:newuser3@test.com][newuser3@test.com]] | 8888888888 |
| [[mailto:newuser4@test.com][newuser4@test.com]] | 7777777777 |
| [[mailto:newuser5@test.com][newuser5@test.com]] | 1212121212 |
| [[mailto:newiser6@test.com][newiser6@test.com]] | 3434343434 |
...
|-------------------------------------------------+----------------+---------------------------------------+------------------------------+----------|
| [[mailto:family1@test.com][family1@test.com]]   | 1111111111     | 1 test rd, auburn hills, mi 48326     | Mother                       | F        |
| [[mailto:family2@test.com][family2@test.com]]   | 2222222222     | 2 test ln, auburn hills, mi 48326     | Father                       | M        |
| [[mailto:family3@test.com][family3@test.com]]   | 3333333333     | 3 test blvd, auburn hills, mi 48326   | Sister                       | F        |
| [[mailto:friend1@test.com][friend1@test.com]]   | 1111111111     | 1 test rd, troy, mi 48084             | Friend                       | F        |
| [[mailto:friend2@test.com][friend2@test.com]]   | 2222222222     | 1 test rd, troy, mi 48084             | Friend                       | M        |
| [[mailto:friend3@test.com][friend3@test.com]]   | 3333333333     | 1 test rd, troy, mi 48084             | Friend                       | F        |
...
| Email                  |
|------------------------|
| [[mailto:nmcox@oakland.edu][nmcox@oakland.edu]]      |
| [[mailto:mbroe@oakland.edu][mbroe@oakland.edu]]      |
| [[mailto:btderr@oakland.edu][btderr@oakland.edu]]     |
| [[mailto:apmorey@oakland.edu][apmorey@oakland.edu]]    |
| [[mailto:tcwatling@oakland.edu][tcwatling@oakland.edu]]  |
| [[mailto:minqianghu@oakland.edu][minqianghu@oakland.edu]] |
...
| Username         | Password  |
|------------------+-----------|
| [[mailto:user7@test.com][user7@test.com]]   | password1 |
| [[mailto:user8@test.com][user8@test.com]]   | password2 |
| [[mailto:user9@test.com][user9@test.com]]   | password3 |
| [[mailto:user10@test.com][user10@test.com]]  | password4 |
| [[mailto:user11@test.com][user11@test.com]]  | password5 |
| [[mailto:user12@gmail.com][user12@gmail.com]] | password6 |
...
| Username         | Password  |
|------------------+-----------|
| [[mailto:user13@test.com][user13@test.com]]  | password1 |
| [[mailto:user14@test.com][user14@test.com]]  | password2 |
| [[mailto:user15@test.com][user15@test.com]]  | password3 |
| [[mailto:user16@test.com][user16@test.com]]  | password4 |
| [[mailto:user17@test.com][user17@test.com]]  | password5 |
| [[mailto:user18@gmail.com][user18@gmail.com]] | password6 |
...
- Test Data: The data that will be used to test the assign official
  ...
  similar to what Law Enforcement uses and sets of missing personx
...
- Test Case ID :: TC1
- Test Case Name :: Register Test
- Requirements Covered :: REQ 1
- Test Setup :: The application needs to be open and the register
                (add) page needs to be active.
...
- Test Data
  ...
  | User       | Five      | [[mailto:user5@test.com][user5@test.com]] | 5555555555 | =ra7)#7#U8%tA!)Zx= | =ra7)#7#U8%tA!)Zx= | Public          |
  | User       | Six       | [[mailto:user6@test.com][user6@test.com]] | 6666666666 | =s$J}Lbys)(t8<yd5= | =s$J}Lbys)(t8<yd5= | Public          |
- Expected Results :: A new user should be added to the users table in
     the database.
- Actual Results
...
**** Requirements Covered
     :PROPERTIES:
     :CUSTOM_ID: requirements-covered-1
     :END:
...
**** Requirements Covered
     :PROPERTIES:
     :CUSTOM_ID: requirements-covered-2
     :END:
...
**** Requirements Covered
     :PROPERTIES:
     :CUSTOM_ID: requirements-covered-3
     :END:
...
**** Requirements Covered
     :PROPERTIES:
     :CUSTOM_ID: requirements-covered-4
     :END:
...
**** Requirements Covered
     :PROPERTIES:
     :CUSTOM_ID: requirements-covered-5
     :END:
...
**** Test Case Steps
     :PROPERTIES:
     :CUSTOM_ID: test-case-steps-5
     :END:

1. Enter the email
2. Enter the password
3. Click the login button
4. Verify you were redirected to "home\_concerned\_public"

**** Test Data
     :PROPERTIES:
     :CUSTOM_ID: test-data-5
     :END:
...
**** Actual Results
     :PROPERTIES:
     :CUSTOM_ID: actual-results-5
     :END:

-  Test 1: Account login successful and redirected to\\
   "home\_concerned\_public"
...
**** Requirements Covered
     :PROPERTIES:
     :CUSTOM_ID: requirements-covered-6
     :END:
...
**** Test Case Steps
     :PROPERTIES:
     :CUSTOM_ID: test-case-steps-6
     :END:

1. Enter the email
2. Enter the password
3. Click the login button
4. Verify you were redirected to "home\_law\_enforcement"

**** Test Data
     :PROPERTIES:
     :CUSTOM_ID: test-data-6
     :END:
...
**** Actual Results
     :PROPERTIES:
     :CUSTOM_ID: actual-results-6
     :END:

-  Test 1: Account login successful and redirected to\\
   "home\_law\_enforcement"
-  Test 2: Account login successful and redirected to\\
   "home\_law\_enforcement"
-  Test 3: Account login successful and redirected to\\
   "home\_law\_enforcement"
...
**** Requirements Covered
     :PROPERTIES:
     :CUSTOM_ID: requirements-covered-7
     :END:
...
*** Sprint 4-7
    :PROPERTIES:
    :CUSTOM_ID: sprint-4-7
    :END:

**** Test Case ID
     :PROPERTIES:
     :CUSTOM_ID: test-case-id-8
     :END:
...
**** Requirements Covered
     :PROPERTIES:
     :CUSTOM_ID: requirements-covered-8
     :END:
...
**** Requirements Covered
     :PROPERTIES:
     :CUSTOM_ID: requirements-covered-9
     :END:
...
**** Requirements Covered
     :PROPERTIES:
     :CUSTOM_ID: requirements-covered-10
     :END:
...
**** Requirements Covered
     :PROPERTIES:
     :CUSTOM_ID: requirements-covered-11
     :END:
...
**** Requirements Covered
     :PROPERTIES:
     :CUSTOM_ID: requirements-covered-12
     :END:
...
** 12.1 Project Plan
   :PROPERTIES:
   :CUSTOM_ID: project-plan-1
   :END:

*** 12.1.1 Gantt Chart
    :PROPERTIES:
    :CUSTOM_ID: gantt-chart-1
    :END:

See\\
[[file:media/MIMS_Project_Plan_FINAL_Gantt.pdf]]\\
for the Gantt chart PDF file.

*** 12.1.2 Task Breakdown
    :PROPERTIES:
    :CUSTOM_ID: task-breakdown-1
    :END:

See\\
[[file:media/MIMS_Project_Plan_FINAL_Tasks.pdf]]\\
for the task breakdown PDF file.

** 12.2 Risk Management
   :PROPERTIES:
   :CUSTOM_ID: risk-management
   :END:

*** Sensitive data being misused
    :PROPERTIES:
    :CUSTOM_ID: sensitive-data-being-misused
    :END:

1.  Risk Details
2.  Personal data about missing people will be maintained in the\\
    database for Law Enforcement to access
3.  There will need to be restrictions to what data the Concerned\\
    Public can see
4.  The integrity of the data needs to be retained
5.  Risk Assessment
6.  Likelihood: 5
7.  Impact: 10
8.  Cost: 10
9.  Rank: 60
10. Mitigation Plan: Our mitigation plan for this is to create roles
    in\\
...
*** High volumes of data are not managed
    :PROPERTIES:
    :CUSTOM_ID: high-volumes-of-data-are-not-managed
    :END:

1. Risk Details
2. The data needs to be stored in a way that makes sense
3. It needs to be easily accessed and analyzed
4. Risk Assessment
5. Likelihood: 8
6. Impact: 5
7. Cost: 2
8. Rank: 36
9. Mitigation Plan: Our mitigation plan for this is to take extra time\\
...
*** Image files are not managed/stored properly
    :PROPERTIES:
    :CUSTOM_ID: image-files-are-not-managedstored-properly
    :END:

1. Risk Details
2. Images need to be stored in a way that they are easily accessed\\
   and associated with the correct missing person report
3. The images need to be managed so they do not take up enormous\\
   amounts of space
4. Risk Assessment:
5. Likelihood: 5
6. Impact: 7
7. Costs: 8
8. Rank: 192
9. Mitigation Plan: Our mitigation plan is to look into the best way\\
...
-  [[https://book.cakephp.org/3.0/en/development/testing.html][CakePHP
   Cookbook: Testing]]
-  [[https://phpunit.de/][PHPUnit]]
-  [[https://www.linkedin.com/pulse/using-phpunit-cakephp-ken-kitchen][LinkedIn:
   Using PHPUnit with CakePHP]]
-  [[https://link.springer.com/chapter/10.1007/978-1-4302-4165-2_33][Springer:
   CakePHP Testing]]
-  [[https://books.google.com/books?id=YZWsK-58eRAC&pg=PA97&lpg=PA97&dq=cakephp+phpunit+tests+update+account+info&source=bl&ots=CUCu0xI1u5&sig=EfGZkNdohVCUxV9qSBT9z9OqAe8&hl=en&sa=X&ved=0ahUKEwj_4MziiYjZAhWB5oMKHZUUBPUQ6AEIUTAH#v=onepage&q=cakephp%20phpunit%20tests%20update%20account%20info&f=false][Google
   Books: CakePHP Unit Testing]]

** 13.2 Creating Views in CakePHP
   :PROPERTIES:
   :CUSTOM_ID: creating-views-in-cakephp
   :END:

-  [[https://book.cakephp.org/3.0/en/views.html][CakePHP Cookbook:
   Views]]

** 13.3 CakePHP Models
   :PROPERTIES:
   :CUSTOM_ID: cakephp-models
   :END:

-  [[https://book.cakephp.org/3.0/en/orm/table-objects.html][CakePHP
   Cookbook: Table Objects]]
-  [[https://book.cakephp.org/3.0/en/orm/entities.html][CakePHP
   Cookbook: Entities]]
-  [[https://book.cakephp.org/3.0/en/orm/behaviors.html][CakePHP
   Cookbook: Behaviors]]

** 13.4 Login/Register Example
   :PROPERTIES:
   :CUSTOM_ID: loginregister-example
   :END:

-  [[https://book.cakephp.org/2.0/en/tutorials-and-examples/blog-auth-example/auth.html][CakePHP
   Cookbook: Simple Authentication and Authorization Application]]
-  [[https://book.cakephp.org/3.0/en/tutorials-and-examples/cms/installation.html][CakePHP
   Cookbook: Content Management Tutorial]]

** 13.5 Installing CakePHP
   :PROPERTIES:
   :CUSTOM_ID: installing-cakephp
   :END:

-  [[https://book.cakephp.org/3.0/en/installation.html][CakePHP
   Cookbook: Installation]]

** 13.6 Google Maps Helper
   :PROPERTIES:
   :CUSTOM_ID: google-maps-helper
   :END:

-  [[https://github.com/marcferna/CakePHP-GoogleMapHelper/tree/CakePHP3][GitHub:
   marcferna/CakePHP-GoogleMapHelper]]

** 13.7 Bootstrap Helper
   :PROPERTIES:
   :CUSTOM_ID: bootstrap-helper
   :END:

-  [[https://github.com/Holt59/cakephp3-bootstrap-helpers/][GitHub:
...
** 13.9 Phinx Database Management
   :PROPERTIES:
   :CUSTOM_ID: phinx-database-management
   :END:

-  [[https://book.cakephp.org/3.0/en/phinx.html][CakePHP Cookbook: Phinx
   Migrations]]
-  [[https://book.cakephp.org/3.0/en/phinx/seeding.html][CakePHP
   Cookbook: Database Seeding]]
