...
| Postconditions:	| The report is approved, has the status “approved”, and is now displayed in the application to the Concerned Citizens to view	      |  
...
| <- 	    | 3.     | The Database changes the report status from “on hold” to “approved”							 |
...
| Participating Actors:	| Database									      |
| Preconditions:	| A report has been submitted by the Concerned Citizen and has the status “active" |
