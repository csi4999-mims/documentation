...
REQ 4, REQ 5, REQ 6
### Test Setup ###  
A new user wants to register a new account and is on the register page.
### Test Case Steps ###  
...
REQ 4
### Test Setup ###  
A registered user (Concerned Citizen or Law Enforcement) needs to reset their password because they have forgotten it and have lost access to their account.  
### Test Case Steps ###  
...
| password6              |
### Expected Results ###  
The Concerned Citizen or Law Enforcement will be able to reset their password and regain access to their account.
### Actual Results ###  
